# telegram status bot v1.2 by @codingstorm (@yfimsky)
...
def send_message(message):
    if message.from_user.id not in banList:
        if message.from_user.id in admin:
            ...
            ping = pythonping.ping('api.telegram.org')  # put ur url here
            ...
            while latency < 2000:
                ...
                bot.send_message(channel, 'Telegram or server is down') # lib thinking 2000 ping = dead
        else:
